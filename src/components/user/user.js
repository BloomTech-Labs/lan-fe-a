                        ...
                        <div className='information'>
                            <div className='left-section'>
                                <div className='display-name-and-track'>
                                    ...
                                    {props.currentUser.track === 'Career Coach' && <p className='track career-coach'>CAREER COACH</p>}
                                    {props.currentUser.track && props.currentUser.track !== 'Career Coach' && <p className='track'>{props.currentUser.track.toUpperCase()}</p>}
                                </div>
