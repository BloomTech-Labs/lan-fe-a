...
import { fetchUser, fetchPost } from '../../actions';
        ...
        <>
            ...
            <PostContainer>
                ...
                <form autoComplete='off' spellCheck='false'>
                    ...
                    <textarea name='comment' type='text' placeholder='How would you approach this question? Any advice or feedback?' />
                ...
                <div className='comments'>
                    ...
                    <div className='comment'>
                        ...
                        <div className='right-section'>
                            ...
                            {props.currentPost.likes !== undefined && <p className='likes'><i className='far fa-thumbs-up'></i>{props.currentPost.likes}</p>}
                        </div>
                    </div>
                    <div className='comment'>
                        {props.currentPost.profile_picture && <img src={props.currentPost.profile_picture} alt='profile icon' onClick={() => props.history.push(`/user/${props.currentPost.user_id}`)} />}
...
export default connect(mapStateToProps, { fetchUser, fetchPost })(Post);